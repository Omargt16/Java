...
public class BuggySearchAndSort {
	 ...
	 */
	/*
	 * public static boolean contains(int[] array, int val) { for (int i = 0; i <
	 * array.length; i++) { if (array[i] == val) return true; else return false; }
	 * return false; }
	 */
	...
	public static void bubbleSort(int[] array) {
		for (int i = 0; i < array.length; i++) {
			...
			for (int j = 0; j < array.length - 1; j++) {// change j here
	...
	public static void selectionSort(int[] array) {
		for (int top = array.length - 1; top > 0; top--) {
			int positionOfMax = 0;
			for (int i = 1; i <= top; i++) {
				if (array[i] > array[positionOfMax])// change i
					positionOfMax = i;
			}
	 ...
	 */
	/*
	 * public static void insertionSort(int[] array) { for (int top = 1; top <
	 * array.length; top++) { int temp = array[top]; // copy item that into temp
	 * variable int pos = top - 1; if(array[pos] > temp) { while (pos > 0 &&
	 * array[pos] > temp) { // move items that are bigger than temp up one position
	 * array[pos + 1] = array[pos]; pos--; } if(pos == 0) { array[pos+1] =
	 * array[pos]; array[pos] = temp; } else { array[pos+1] = temp; // place temp
	 * into last vacated position } } //int aux = 0; }
	 */
